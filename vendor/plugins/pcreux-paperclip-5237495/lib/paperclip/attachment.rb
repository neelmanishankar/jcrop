...
module Paperclip
  ...
  class Attachment
    ...
    def assign uploaded_file
      ...
      # Appends the time before the file name
      filename= "#{Time.now.to_i}_" + uploaded_file.original_filename.strip   
     

      
      @queued_for_write[:original]   = uploaded_file.to_tempfile
      instance_write(:file_name,       filename)
    ...
    def post_process_styles #:nodoc:
      @styles.each do |name, args|
        begin
          ...
          log("this is the queued for write"+@queued_for_write[:original].inspect)
